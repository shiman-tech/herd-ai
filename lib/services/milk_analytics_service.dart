          ...
          if (countPast >= 3) {
            ...
            if (pastAvg > 0 && latest.totalYield < (pastAvg * 0.70)) {
              ...
              alerts.add(MilkAlert(
                ...
                message: 'Cow #${cattle.id} milk production dropped ${dropPercent.toStringAsFixed(0)}% (${latest.totalYield.toStringAsFixed(1)} L vs ${pastAvg.toStringAsFixed(1)} L avg).',
      ...
      if (cattle.isPregnant && cattle.expectedCalvingDate != null) {
        ...
        if (daysToCalving > 0 && daysToCalving <= 60 && cattle.isMilking) {
          alerts.add(MilkAlert(
            ...
            message: 'Cow #${cattle.id} is expected to calve in $daysToCalving days. Prepare cow for dry period.',
            severity: AlertSeverity.warning,
        ...
        if (daysToCalving < 0) {
          ...
          alerts.add(MilkAlert(
            ...
            message: 'Cow #${cattle.id} expected calving date was $daysOverdue day${daysOverdue == 1 ? '' : 's'} ago (${cattle.expectedCalvingDate!.day}/${cattle.expectedCalvingDate!.month}/${cattle.expectedCalvingDate!.year}). Update calving information or pregnancy status.',
          ...
          alerts.add(MilkAlert(
            ...
            message: 'Cow #${cattle.id} is due for calving in $daysToCalving day${daysToCalving == 1 ? '' : 's'}. Prepare maternity pen.',
            severity: AlertSeverity.danger,
